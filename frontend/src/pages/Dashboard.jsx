...
import { LogOut, User, Briefcase, Settings, LayoutDashboard, Grid3X3, Layers } from 'lucide-react';
...
export default function Dashboard() {
  ...
  return (
    <div className="flex flex-col min-h-screen font-sans text-white bg-gray-900">
      {/* Dashboard Header - Dark and sleek */}
      <header className="sticky top-0 z-50 bg-gray-800 border-b border-gray-700 shadow-lg">
        <div className="container flex items-center justify-between px-6 py-5 mx-auto">
          <Link to="/" className="flex items-center gap-2 text-3xl font-extrabold tracking-widest text-white uppercase">
      ...
      <main className="container flex-1 px-6 py-12 mx-auto">
        ...
        {role === "admin" ? (
          ...
          <div className="p-8 bg-gray-800 border border-gray-700 shadow-xl rounded-2xl">
            ...
            <ul className="grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-3">
              <li className="p-6 transition-all duration-300 transform bg-gray-900 shadow-md rounded-xl hover:shadow-2xl hover:-translate-y-1">
                <Link to="/admin/teams" className="flex items-center gap-2 font-semibold text-indigo-400 transition-colors duration-300 hover:text-indigo-300">
                  <Grid3X3 className="w-5 h-5" />
                  Manage Teams
                </Link>
              </li>
              <li className="p-6 transition-all duration-300 transform bg-gray-900 shadow-md rounded-xl hover:shadow-2xl hover:-translate-y-1">
                <Link to="/admin/plans" className="flex items-center gap-2 font-semibold text-indigo-400 transition-colors duration-300 hover:text-indigo-300">
                  <Layers className="w-5 h-5" />
                  Manage Plans
                </Link>
              </li>
              <li className="p-6 transition-all duration-300 transform bg-gray-900 shadow-md rounded-xl hover:shadow-2xl hover:-translate-y-1">
                <Link to="/admin/users" className="flex items-center gap-2 font-semibold text-indigo-400 transition-colors duration-300 hover:text-indigo-300">
          ...
          <div className="p-8 bg-gray-800 border border-gray-700 shadow-xl rounded-2xl">
            ...
            <p className="mb-6 text-gray-400">
              Access your personal tools to streamline your tendering process and win more bids.
            </p>
            <ul className="grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-3">
              <li className="p-6 transition-all duration-300 transform bg-gray-900 shadow-md rounded-xl hover:shadow-2xl hover:-translate-y-1">
                <Link to="/user/plan" className="flex items-center gap-2 font-semibold text-green-400 transition-colors duration-300 hover:text-green-300">
                  <Settings className="w-5 h-5" />
                  View My Plan
                </Link>
              </li>
              <li className="p-6 transition-all duration-300 transform bg-gray-900 shadow-md rounded-xl hover:shadow-2xl hover:-translate-y-1">
                <Link to="/user/summaries" className="flex items-center gap-2 font-semibold text-green-400 transition-colors duration-300 hover:text-green-300">
                  <Layers className="w-5 h-5" />
                  Access Tender Summaries
                </Link>
              </li>
              <li className="p-6 transition-all duration-300 transform bg-gray-900 shadow-md rounded-xl hover:shadow-2xl hover:-translate-y-1">
                <Link to="/user/readiness" className="flex items-center gap-2 font-semibold text-green-400 transition-colors duration-300 hover:text-green-300">
